 ...
 */
package io.vulpine.connectwise.api.endpoints.contact.delete;
...
public class DeleteContactNote extends DeleteRequest
{
  ...
  {
    super(credentials, xmlMapper, subApiInterface, Endpoint.CONTACT, id);
  }
}
