 ...
 *
 */
package io.vulpine.connectwise.api.endpoints.company.delete;
...
{
  public DeleteCompanyNote( final Credentials c, final XmlMapper x, final SubApiInterface i, final int id )
  {
    super(c, x, i, Endpoint.COMPANY, id);
  }
}
