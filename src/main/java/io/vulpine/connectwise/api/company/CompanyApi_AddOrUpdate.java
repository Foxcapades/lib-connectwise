...
public class CompanyApi_AddOrUpdate extends ApiDivision
{
  public CompanyApi_AddOrUpdate( final Credentials credentials, final XmlMapper mapper, final SubApiInterface api )
  {
