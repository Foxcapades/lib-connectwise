...
import io.vulpine.connectwise.api.activity.delete.DeleteActivity;
import io.vulpine.connectwise.api.common.ApiDivision;
import io.vulpine.connectwise.api.def.SubApiInterface;
import io.vulpine.connectwise.api.common.Credentials;

public class ActivityApi_Delete extends ApiDivision
{
  public ActivityApi_Delete( final Credentials credentials, final XmlMapper mapper, final SubApiInterface api )
  {
