...
public class ActivityApi_AddOrUpdate_Test
{
  ...
  {
    addOrUpdate = new ActivityApi_AddOrUpdate(null, null, null);
  }

  @Test
  public void activity_does_not_return_null() throws Exception
  {
    Assert.assertNotNull(addOrUpdate.activity());
  }

  @Test
  public void activity_returns_new_instances_each_call() throws Exception
  {
    Assert.assertNotSame(addOrUpdate.activity(), addOrUpdate.activity());
  }
}
