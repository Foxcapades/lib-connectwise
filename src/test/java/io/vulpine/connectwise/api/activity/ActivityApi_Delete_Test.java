...
public class ActivityApi_Delete_Test
{
  ...
  {
    delete = new ActivityApi_Delete(null, null, null);
  }

  @Test
  public void activity_does_not_return_null() throws Exception
  {
    Assert.assertNotNull(delete.activity(666));
  }

  @Test
  public void activity_returns_new_instances_each_call() throws Exception
  {
    Assert.assertNotSame(delete.activity(666), delete.activity(666));
  }
