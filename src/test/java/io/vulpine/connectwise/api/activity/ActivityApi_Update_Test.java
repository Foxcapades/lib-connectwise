...
public class ActivityApi_Update_Test
{
  ...
  {
    update = new ActivityApi_Update(null,null,null);
  }

  @Test
  public void activity_does_not_return_null() throws Exception
  {
    Assert.assertNotNull(update.activity());
  }

  @Test
  public void activity_returns_new_instances_each_call() throws Exception
  {
    Assert.assertNotSame(update.activity(), update.activity());
  }
}
