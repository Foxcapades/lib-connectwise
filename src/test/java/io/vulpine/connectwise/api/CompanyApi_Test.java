...
public class CompanyApi_Test
{
  ...
  public void setUp()
  {
    api = new CompanyApi(null, null, null, "");
  }
  ...
  public class getAll extends SubApiMethodTest
  {
    @Override public Method getMethod() throws NoSuchMethodException { return api.getClass().getMethod("getAll"); }
    @Override public SubApiInterface getApi() { return api; }
  }
