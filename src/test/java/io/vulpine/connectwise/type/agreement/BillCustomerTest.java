...
public class BillCustomerTest
{
  private static Field value;

  private final BillCustomer type;

  public BillCustomerTest( BillCustomer type )
  {
    this.type = type;
  }
  ...
  {
    value = BillCustomer.class.getDeclaredField("value");
  ...
  {
    assertEquals(type, BillCustomer.fromString((String) value.get(type)));
  }

  @Test
  public void fromString_returns_null_on_unknown_value()
  {
    assertNull(BillCustomer.fromString("asdl;fjfasd"));
  }
