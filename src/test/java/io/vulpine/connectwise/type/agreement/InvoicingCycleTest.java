...
public class InvoicingCycleTest
{
  private static Field value;

  private final InvoicingCycle type;

  public InvoicingCycleTest( InvoicingCycle type )
  {
    this.type = type;
  }
  ...
  {
    value = InvoicingCycle.class.getDeclaredField("value");
  ...
  {
    assertEquals(type, InvoicingCycle.fromString((String) value.get(type)));
  }

  @Test
  public void fromString_returns_null_on_unknown_value()
  {
    assertNull(InvoicingCycle.fromString("asdl;fjfasd"));
  }
}
