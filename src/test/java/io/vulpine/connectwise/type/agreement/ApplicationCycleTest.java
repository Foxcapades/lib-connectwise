...
public class ApplicationCycleTest
{
  ...
  private final ApplicationCycle type;

  public ApplicationCycleTest( ApplicationCycle type )
  {
    this.type = type;
  }
  ...
  {
    value = ApplicationCycle.class.getDeclaredField("value");
  ...
  {
    return ApplicationCycle.values();
  }
  ...
  {
    assertEquals(type, ApplicationCycle.fromString((String) value.get(type)));
  }

  @Test
  public void fromString_returns_null_on_unknown_value()
  {
    assertNull(ApplicationCycle.fromString("asdl;fjfasd"));
  }
}
