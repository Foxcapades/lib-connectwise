...
public class BillableOptionTest
{
  private static Field value;

  private final BillableOption type;

  public BillableOptionTest( BillableOption type )
  {
    this.type = type;
  }
  ...
  {
    value = BillableOption.class.getDeclaredField("value");
  ...
  {
    assertEquals(type, BillableOption.fromString((String) value.get(type)));
  }

  @Test
  public void fromString_returns_null_on_unknown_value()
  {
    assertNull(BillableOption.fromString("asdl;fjfasd"));
  }
}
