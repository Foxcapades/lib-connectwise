...
public class PriceAttributeTest
{
  ...
  private final PriceAttribute type;

  public PriceAttributeTest( PriceAttribute type )
  {
    this.type = type;
  }
  ...
  {
    value = PriceAttribute.class.getDeclaredField("value");
  ...
  {
    assertEquals(type, PriceAttribute.fromString((String) value.get(type)));
  }

  @Test
  public void fromString_returns_null_on_unknown_value()
  {
    assertNull(PriceAttribute.fromString("asdl;fjfasd"));
  }
